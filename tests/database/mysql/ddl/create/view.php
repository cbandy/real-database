 ...
 */
class Database_MySQL_DDL_Create_View_Test extends PHPUnit_Framework_TestCase
{
	/**
	 * @covers  Database_MySQL_DDL_Create_View::algorithm
	 */
	public function test_algorithm()
	{
		$db = $this->getMockForAbstractClass('Database', array('name', array(), '`'));
		$command = new Database_MySQL_DDL_Create_View('a', new Database_Query('b'));
	...
	/**
	 * @covers  Database_MySQL_DDL_Create_View::check
	 */
	...
	/**
	 * @covers  Database_MySQL_DDL_Create_View::__toString
	 */
	public function test_toString()
	{
		$command = new Database_MySQL_DDL_Create_View;
		$command
			->replace()
			->algorithm('a')
			->columns(array('b'))
