 ...
 * @group   database
 */
class Database_Base_Savepoint_Deep_Test extends PHPUnit_Framework_TestCase
{
	/**
	 * @covers  Database_Savepoint_Deep::push
	 */
	public function test_push()
	{
		$stack = new Database_Savepoint_Deep;
	...
	/**
	 * @covers  Database_Savepoint_Deep::pop
	 */
	...
	/**
	 * @covers  Database_Savepoint_Deep::position
	 */
	...
	public function test_position_duplicate()
	{
		...
		$this->assertSame(3, $stack->position('a'));
		$this->assertSame(2, $stack->position('b'));
	}
	...
	public function provider_pop_until()
	{
		return array(
			...
			array(array('a', 'b', 'a'), 'b', 2),
			array(array('a', 'b', 'a'), 'a', 3),
		);
	}

	/**
	 * @covers  Database_Savepoint_Deep::pop_until
	 *
	...
	/**
	 * @covers  Database_Savepoint_Deep::reset
	 */
