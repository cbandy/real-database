 ...
 */
class Database_Base_DML_Delete_Test extends PHPUnit_Framework_TestCase
{
	/**
	 * @covers  Database_DML_Delete::as_assoc
	 */
	...
	/**
	 * @covers  Database_DML_Delete::as_object
	 *
	...
	/**
	 * @covers  Database_DML_Delete::returning
	 *
